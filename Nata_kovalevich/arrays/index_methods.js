// 1.сформировать массив чисел, которые делятся на 3 (число элементов 8)
...
//2. Создать с помощью цикла массив, каждый элемент которого равен
...
// 3.Создать с помощью цикла массив, который одинаково читается как слева 
...
// 4.Создать массив из 10 чисел.Вывести на экраны 
